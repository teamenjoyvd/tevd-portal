# PROJECT-NOTES.md — teamenjoyVD Portal (unsorted pre-migration material)

Project-authored archive. Exempt from `docs/guardrails/_FORMAT.md` doc-shape rules — transported content is never reformatted.

## Unsorted (pre-migration docs/ai/REFACTOR.md, 2026-07-06)

Transported verbatim and in full from `docs/ai/REFACTOR.md` — a living refactor-findings log (project history/working data, not a rule surface). Nothing summarized or dropped. The original `docs/ai/REFACTOR.md` is LEFT in place (living doc, GitHub issue #427); this is a point-in-time verbatim copy.

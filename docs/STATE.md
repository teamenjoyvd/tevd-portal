...
NOTED (not done): QA.md live backlog items to file as GitHub issues — roles-page history view refactor; user-dropdown profile link. NOTED: system-prompt.xml kept its instructional mode comments (load-bearing), 146→~127 lines vs plan's ~90 estimate.

export const profile = {
  ...
  'profile.adminTools':                   { en: 'Admin Tools',       bg: 'Администраторски инструменти' },
  'profile.adminTools.admin':             { en: 'Admin',             bg: 'Админ'                        },
  'profile.adminTools.portalManagement':  { en: 'Portal management', bg: 'Управление на портала'        },
  'profile.spouseLinkBanner.single':      { en: 'Someone has requested to link as your spouse account', bg: 'Някой е поискал да се свърже като акаунт на съпруг/а' },
  'profile.spouseLinkBanner.multiple':    { en: '{{count}} spouse link requests pending', bg: '{{count}} чакащи заявки за свързване на съпруг/а' },

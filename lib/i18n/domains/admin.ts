export const admin = {
  ...
  'admin.content.guides.dialog.body': { en: 'This cannot be undone.', bg: 'Действието е необратимо.' },
  ...
  'admin.content.links.placeholder.labelBg': { en: 'Етикет на български', bg: 'Етикет на български' },

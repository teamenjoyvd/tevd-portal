export const admin = {
  ...
  'admin.content.page.tab.bento': { en: 'Bento', bg: 'Бенто' },
  ...
  'admin.content.announcements.btn.publishing': { en: 'Publishing…', bg: 'Публикуване…' },
  'admin.content.announcements.btn.publish': { en: 'Publish', bg: 'Публикувай' },
  'admin.content.announcements.btn.edit': { en: 'Edit', bg: 'Редактирай' },
  'admin.content.announcements.btn.delete': { en: 'Delete', bg: 'Изтрий' },
  'admin.content.announcements.drawer.editTitle': { en: 'Edit announcement', bg: 'Редактиране на обявление' },
  'admin.content.announcements.btn.saving': { en: 'Saving…', bg: 'Запазване…' },
  'admin.content.announcements.btn.saveChanges': { en: 'Save changes', bg: 'Запази промените' },
  'admin.content.announcements.btn.cancel': { en: 'Cancel', bg: 'Откажи' },
  'admin.content.announcements.dialog.title': { en: 'Delete announcement', bg: 'Изтриване на обявление' },
  ...
  'admin.content.bento.btn.saving': { en: 'Saving…', bg: 'Запазване…' },
  'admin.content.bento.btn.saved': { en: 'Saved ✓', bg: 'Запазено ✓' },
  'admin.content.bento.btn.save': { en: 'Save', bg: 'Запази' },
  'admin.content.bento.tile.events': { en: 'Events tile', bg: 'Плочка Събития' },
  'admin.content.bento.tile.trips': { en: 'Trips tile', bg: 'Плочка Пътувания' },
  'admin.content.bento.tile.announcements': { en: 'Announcements tile', bg: 'Плочка Обявления' },
  'admin.content.bento.tile.howtos': { en: 'Howtos tile', bg: 'Плочка Наръчници' },
  'admin.content.bento.tile.links': { en: 'Links & Guides tile', bg: 'Плочка Връзки и Ръководства' },

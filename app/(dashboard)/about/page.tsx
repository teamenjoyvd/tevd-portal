  ...
  return (
    <div className="py-8 pb-16">
      <BentoGrid>
        ...
        {/* ── ROW 1+2: Image col-4 rowSpan-2 | Text col-4 rowSpan-2 ── */}

        {/* col-4 rowSpan-2: hero image */}
        <div
        ...
        {/* col-4 rowSpan-2: heading + body copy */}
        <BentoCard
          variant="default"
          colSpan={4}
          rowSpan={2}
        ...
        {/* ── ROW 2 fills cols 5–8: col-1 email | col-1 instagram | col-2 map ── */}

        {/* col-1: email icon tile */}
        <BentoCard variant="forest" colSpan={1} className="flex flex-col items-center justify-center gap-2">
          <a
        ...
        {/* col-1: instagram icon tile */}
        <BentoCard variant="teal" colSpan={1} className="flex flex-col items-center justify-center gap-2">
          <a
        ...
        {/* ── ROW 3: col-8 CTA text ── */}

        <BentoCard variant="default" colSpan={8} className="flex items-center">
          <p className="text-base leading-relaxed font-body" style={{ color: 'var(--text-secondary)' }}>
